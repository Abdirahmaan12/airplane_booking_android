...
public class login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText txtusername = findViewById(R.id.idusername);
        EditText txtpassword = findViewById(R.id.iduserpass);
    ...
    void checkcustomer(String username , String password ){
        String url ="http://10.0.2.2/airplanebooking/customers.php?username="+username+"&password="+password;
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            if (ob.getString("code").equals("yes")){
                                preManager pr = new preManager(login.this);
                                pr.setcustomers_id(ob.getString("customers_id"));


                                Intent gologin = new Intent(login.this, pageone.class);
